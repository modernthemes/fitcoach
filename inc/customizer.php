...
function fitcoach_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_setting( 'cta_text', array(
		'default' => 'Get in the best shape of your life, with me at your side.',
		'sanitize_callback' => 'fitcoach_sanitize_text',
	) );
...
function fitcoach_add_customizer_css() {
	$color = fitcoach_sanitize_hex_color( get_theme_mod( 'fitcoach_link_color' ) );
	?>
	...
	<style>
		...
		a:hover {
			color: <?php echo get_theme_mod( 'fitcoach_hover_color' ) ?>;
		}
		
		.class h2 { color: <?php echo get_theme_mod( 'fitcoach_custom_color' ) ?>; }  
		.main-navigation ul ul li { border-color: <?php echo get_theme_mod( 'fitcoach_custom_color' ) ?>; }  
		.schedule-title span { background: <?php echo get_theme_mod( 'fitcoach_custom_color' ) ?>; }  
		#sequence .animate-in .slide-title { background: <?php echo get_theme_mod( 'fitcoach_custom_color' ) ?>; } 
		.red-plus { border-color: <?php echo get_theme_mod( 'fitcoach_custom_color' ); ?>; color: <?php echo get_theme_mod( 'fitcoach_custom_color' ) ?>; }  
		.dark-plus { border-color: <?php echo get_theme_mod( 'fitcoach_custom_color' ); ?>; color: <?php echo get_theme_mod( 'fitcoach_custom_color' ) ?>; } 
		button, input[type="button"], input[type="reset"], input[type="submit"] { background: <?php echo get_theme_mod( 'fitcoach_custom_color' ) ?>; }
		.home-blog-title span { background: <?php echo get_theme_mod( 'fitcoach_custom_color' ); ?>; } 
		.class-schedule { border-color: <?php echo get_theme_mod( 'fitcoach_custom_color' ); ?>; color: <?php echo get_theme_mod( 'fitcoach_custom_color' ); ?>; }  
		blockquote { border-color: <?php echo get_theme_mod( 'fitcoach_custom_color' ) ?>; } 
		.main-navigation li:hover > a { color: <?php echo get_theme_mod( 'fitcoach_custom_color' ) ?>; } 
		.custom_border_top { border-color: <?php echo get_theme_mod( 'fitcoach_custom_color' ) ?>; } 
		.entry-meta, .entry-meta a { color: <?php echo get_theme_mod( 'fitcoach_custom_color' ) ?>; }
		
		button:hover, input[type="button"]:hover, input[type="reset"]:hover, input[type="submit"]:hover { background: <?php echo get_theme_mod( 'fitcoach_custom_color_hover' ) ?>; }
		
		.site-footer { background-color: <?php echo get_theme_mod( 'fitcoach_footer_bgcolor' ); ?> !important; }  
	</style>
<?php }
