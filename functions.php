...
new WPUpdatesThemeUpdater_924( 'http://wp-updates.com/api/2/theme', basename( get_template_directory() ) ); 
...
function fitcoach_widgets_init() {
	...
	register_sidebar( array(
		...
		'id'            => 'sidebar-class',
		'description'   => 'This sidebar will appear on each individual class post.',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
    ...
    $meta_boxes['test_metabox'] = array(
        ...
        'fields' => array(
            ...
            array(
				...
				'desc' => 'Enter the embed URL of a custom google map.<br />You can generate it <a href="https://www.google.com/maps/">here</a>. For instructions, click <a href="https://support.google.com/maps/answer/3544418?hl=en">here</a>.',
                'id' => $prefix . 'class_map',
                'type' => 'textarea_code'
            ),
