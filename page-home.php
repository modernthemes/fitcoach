...
get_header(); ?> 
    	...
    	<div class="grid home-class-grid">
    		...
    		<?php if ( get_theme_mod( 'class_title_text' ) ) : ?>
    			<div class="schedule-title">
    				<span><?php echo get_theme_mod( 'class_title_text' ); ?></span>
    			</div><!-- schedule-title -->
    		<?php else : ?> 
			<?php endif; ?> 
    ...
    <div class="side-pad">
    	<div class="grid cta" style="background: url('<?php echo get_theme_mod( 'cta_background' ); ?>') center center no-repeat;">
    		<div class="col-1-1">
            	
                <h2> 
            	<?php if ( get_theme_mod( 'cta_text' ) ) : ?>
    				<?php echo get_theme_mod( 'cta_text' ); ?> 
                <?php endif; ?>
                
                <?php if ( get_theme_mod( 'cta_button_text' ) ) : ?>
                	<a href="<?php echo get_page_link(get_theme_mod('fitcoach_ctalink_url'))?>"><button class="alignright"><?php echo get_theme_mod( 'cta_button_text' ); ?></button></a>
                <?php endif; ?> 
                </h2>
    ...
    <div class="side-pad">
    	<div class="grid home-class-grid"> 
        	<?php if ( get_theme_mod( 'fc_blog_title' ) ) : ?>  
				<div class="home-blog-title"><span><?php echo get_theme_mod( 'fc_blog_title' ); ?></span></div><!-- home-blog-title -->
        	<?php endif; ?>
		</div><!-- grid -->
    </div><!-- side-pad --> 
